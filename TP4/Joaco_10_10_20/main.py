...
def mackeyglass_dxdt(x, t):
  if (t <= 0):
    return 0.5
  else:
    #x5 = powerint(x, 5)
    x5 = _binaryExponent(x, 5)
    t02 = t - 0.2
    return 6 - (16 * x * x5 * t02)/(1 + x5 * t02)
...
def powerint (x, p):
    ...
    if negativeExponent == True and result != 0:
...
if __name__ == "__main__":
  ...
  ejemplosclase.plotejemplo(T/10000)
  ejemplosclase.plotshow()